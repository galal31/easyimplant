...
CREATE TABLE `payments` (
  ...
  `receipt_file_path` varchar(255) DEFAULT NULL COMMENT 'Path to uploaded receipt image/pdf; null for gateway payments',
  ...
  `payment_source` enum('manual_receipt','xpay') NOT NULL DEFAULT 'manual_receipt',
  `amount` decimal(10,2) DEFAULT NULL,
  `currency` char(3) NOT NULL DEFAULT 'EGP',
  `provider_session_id` varchar(100) DEFAULT NULL,
  `provider_payment_intent_id` varchar(100) DEFAULT NULL,
  ...
  UNIQUE KEY `uq_payments_provider_intent` (`provider_payment_intent_id`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `request_review_files`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `request_review_files` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `request_review_packages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `request_review_packages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `request_id` int(11) NOT NULL,
  `admin_id` int(11) DEFAULT NULL,
...
CREATE TABLE `requests` (
  ...
  `status` enum('pending_review','awaiting_clinic_approval','pending_payment','in_progress','completed','rejected') DEFAULT 'pending_review',
